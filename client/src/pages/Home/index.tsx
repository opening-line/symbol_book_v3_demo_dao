    ...
    <div>
      ...
      {isSSSLinked ? (
          ...
          <ul style={{
            ...
            {mosaics.map((mosaic, index) => (
              <li 
                ...
                style={{
                  padding: '12px',
                  borderBottom: index === mosaics.length - 1 ? 'none' : '1px solid #E0E0E0',
                  display: 'flex',
        ...
        <div>
          ...
          <p>SSS Extensionをインストールしていない場合は<a href="https://chromewebstore.google.com/detail/sss-extension/llildiojemakefgnhhkmiiffonembcan" target="_blank" rel="noopener noreferrer">こちら</a></p>
          <p>SSS Extensionの設定方法は<a href="https://docs.sss-symbol.com/ja/UsersGuide/AccountSetting" target="_blank" rel="noopener noreferrer">こちら</a></p>
        </div>
      )}
    </div>
  );
